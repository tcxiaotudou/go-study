...
func (pc *PokemonCreate) SetCreateAt(t time.Time) *PokemonCreate {
	pc.mutation.SetCreateAt(t)
	return pc
}

// SetNillableCreateAt sets the "create_at" field if the given value is not nil.
func (pc *PokemonCreate) SetNillableCreateAt(t *time.Time) *PokemonCreate {
	if t != nil {
		pc.SetCreateAt(*t)
	}
	return pc
...
func (pc *PokemonCreate) SetUpdateAt(t time.Time) *PokemonCreate {
	pc.mutation.SetUpdateAt(t)
	return pc
}

// SetNillableUpdateAt sets the "update_at" field if the given value is not nil.
func (pc *PokemonCreate) SetNillableUpdateAt(t *time.Time) *PokemonCreate {
	if t != nil {
		pc.SetUpdateAt(*t)
	}
	return pc
...
func (pc *PokemonCreate) check() error {
	...
	if _, ok := pc.mutation.CreateAt(); !ok {
		return &ValidationError{Name: "create_at", err: errors.New(`ent: missing required field "Pokemon.create_at"`)}
	}
	if _, ok := pc.mutation.UpdateAt(); !ok {
		return &ValidationError{Name: "update_at", err: errors.New(`ent: missing required field "Pokemon.update_at"`)}
	}
	return nil
}
